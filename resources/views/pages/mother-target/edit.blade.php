                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ route('mother-target.update', $motherTarget->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-sm-4">
                                            ...
                                            <select class="form-select mb-3" name="village_id" required>
                                                ...
                                                @foreach ($villages as $village)
                                                    <option value="{{ $village->id }}"
                                                        {{ $motherTarget->village_id == $village->id ? 'selected' : '' }}>
                                                        {{ $village->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('village_id')
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" value="{{ $motherTarget->pregnant }}"
                                                class="form-control @error('pregnant') is-invalid @enderror"
                                                name="pregnant" placeholder="Jumlah Ibu Hami" required>
                                            @error('pregnant')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" value="{{ $motherTarget->no_pregnant }}"
